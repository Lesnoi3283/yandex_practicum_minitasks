...
// I DID`NT WROTE THIS CODE MYSELF. This code is from example!
...
func main() {
	...
	clientConn, err := grpc.NewClient(":3200", grpc.WithTransportCredentials(insecure.NewCredentials()))
	if err != nil {
		log.Fatal(err)
	}
	...
	c := pb.NewUsersClient(clientConn)
