...
//codegen must generate this code for each element in enum:
...
// This file was generated by genstructs.go
...
var tmpl = template.Must(template.New("struct").Parse(templateStr))
